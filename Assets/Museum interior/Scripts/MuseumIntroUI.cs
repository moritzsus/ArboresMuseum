    ...
    private void ShowIntro()
    {
        ...
        if (infoText)
        {
            ...
            infoText.text = (mode == GameMode.Play)
                ? "Du hast den Spielen-Modus gew‰hlt. Das bedeutet, dass zu Beginn nur ein Raum begehbar ist. Die Anderen kannst du freischalten, in dem du das jeweilige Minispiel im Raum abschlieﬂt. Versuche dir die Werke und die zugehˆrigen Informationen gut einzupr‰gen; das kann in den Minispielen von Vorteil sein. Viel Spaﬂ beim spielerischen Erkunden des Museums zu Arbores Consanguinitatis."
